    ...
    <div className="adilitix-container">
      ...
      <header className={`hero ${isVisible ? 'fade-in' : ''}`}>
        <div className="hero-content">
          <h1>Pioneering the <span className="highlight">Future</span> of Robotics</h1>
          <p>We build intelligent machines that bridge the gap between imagination and reality.</p>
          <div className="cta-group">
            <button className="cta-primary">Explore Our Tech</button>
            <button className="cta-secondary" onClick={() => window.location.href = '/'}>View Hyperclass</button>
          </div>
        </div>
      ...
      <section id="products" className="products-section">
        ...
        <div className="product-card clickable" onClick={() => window.location.href = '/'}>
